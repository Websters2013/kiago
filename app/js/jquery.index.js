    ...
    var Menu = function(obj) {
        ...
        var _addEvents = function() {
                ...
                _itemLink.on( 'click', function () {
                    ...
                    if ( curBtn.next().is( '.menu__sum-menu' ) ) {

                        var curSubMenu = curBtn.next( '.menu__sum-menu' ),
                            curSubMenuWrap = curSubMenu.find( 'ul' );

                        if ( !curSubMenu.hasClass( 'show' ) ) {
                            curSubMenu.addClass( 'show' );
                            curSubMenu.height( curSubMenuWrap.outerHeight() );
                        } else {
                            curSubMenu.removeClass( 'show' );
                            curSubMenu.removeAttr( 'style' );
                        }
